...
```sh
curl -fsSL https://gist.githubusercontent.com/TomasGomes02/c5538fb7a45f8b1fa79c1bd156e9a4b1/raw/7394fa511e9e11134cd1bd4f2ef287679be59374/init-database-vm.sh | sudo bash
```
