...
```sh
curl -fsSL https://gist.githubusercontent.com/TomasGomes02/c5538fb7a45f8b1fa79c1bd156e9a4b1/raw/48e961063aadb198c6b66e5035d54cd0b4151bed/init-database-vm.sh | sudo bash
```
