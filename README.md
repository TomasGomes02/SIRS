...
```sh
curl -fsSL https://gist.githubusercontent.com/TomasGomes02/c5538fb7a45f8b1fa79c1bd156e9a4b1/raw/b0c8d860f92ffec6d7ea9eedb10b67f6ede45c77/init-database-vm.sh | sudo bash
```
