...
```sh
curl -fsSL https://gist.githubusercontent.com/TomasGomes02/c5538fb7a45f8b1fa79c1bd156e9a4b1/raw/dab9412693cc76da938a6f11bfd6b9408ea9f31f/init-database-vm.sh | sudo bash
```
