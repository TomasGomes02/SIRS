...
```bash
curl -fsSL https://gist.githubusercontent.com/tomasmatos6/beeaaaffec51e330f78cc526f80a21d2/raw/c832db3f3ee27d3cfc82a471ce208b90dbe46918/init-auth-vm.sh | sudo bash
```
