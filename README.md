...
```sh
curl -fsSL https://gist.githubusercontent.com/TomasGomes02/c5538fb7a45f8b1fa79c1bd156e9a4b1/raw/31175f13f235c0b5d20557f65fba7eb15405e9e0/init-database-vm.sh | sudo bash
```
