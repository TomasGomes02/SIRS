...
```sh
curl -fsSL https://gist.githubusercontent.com/TomasGomes02/c5538fb7a45f8b1fa79c1bd156e9a4b1/raw/8ed79ba5d58e72605f8c6587b55f19891d6f29c0/init-database-vm.sh | sudo bash
```
