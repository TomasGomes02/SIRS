...
```sh
curl -fsSL https://gist.githubusercontent.com/TomasGomes02/c5538fb7a45f8b1fa79c1bd156e9a4b1/raw/a334dc2ddfdc0ef7f76d15ded2af83a576690f90/init-database-vm.sh | sudo bash
```
