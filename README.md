...
```bash
curl -fsSL https://gist.githubusercontent.com/TomasGomes02/c5538fb7a45f8b1fa79c1bd156e9a4b1/raw/e7bb90e416f5190878788f3f2262d7a156c8b5ca/init-database-vm.sh | sudo bash
```
